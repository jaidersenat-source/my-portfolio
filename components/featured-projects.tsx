...
const featuredProjects = [
  ...
  },
  {
    id: 3,
    title: "SER Neiva",
    description: "SER Neiva es un sistema web para la gestión y visualización de iglesias en Neiva, Huila. Muestra en un mapa las iglesias registradas y sus eventos. Cuenta con un panel de administrador para gestionar la información, además de funciones para importar y exportar datos en Excel y PDF.",
    image: "/3.png",
    technologies: ["PHP", "JavaScript", "Blade", "CSS"],
